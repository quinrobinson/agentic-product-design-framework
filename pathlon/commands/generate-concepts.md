...
Collect any missing inputs, then run the concept-generation skill.
...
When the output is final, save a summary to Pathlon (`write_memory`, `memory_type: "context"`, phase `03`) and record where the full document lives.
