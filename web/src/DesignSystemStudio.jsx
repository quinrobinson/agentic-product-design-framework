...
const THEMES = {
  precision: {
    ...
    archetype: "Vercel",
    primary: "#171717", secondary: "#666666", accent: "#0070F3",
    success: "#0070F3", warning: "#F5A623", error: "#EE0000", info: "#0070F3",
    surface: "#FFFFFF", surfaceSecondary: "#FAFAFA", border: "#EAEAEA",
    textPrimary: "#171717", textSecondary: "#666666", textTertiary: "#999999",
  ...
  warmth: {
    ...
    archetype: "Headspace",
    primary: "#FF7E1D", secondary: "#413D45", accent: "#FFCE00",
    success: "#01A652", warning: "#FFCE00", error: "#E01E5A", info: "#0C6FF9",
    surface: "#FDF5EB", surfaceSecondary: "#FFF7ED", border: "#E8E0D5",
    textPrimary: "#2C2C3A", textSecondary: "#5E5B63", textTertiary: "#8E8B93",
    fontHeading: "'Libre Baskerville', serif", fontBody: "'Nunito', sans-serif", fontMono: "'Roboto Mono', monospace",
    headingWeight: 700, baseSize: 16, scaleRatio: 1.25, spaceUnit: 4,
    radiusSm: 8, radiusMd: 12, radiusLg: 16, radiusFull: 9999,
    shadowSm: "0 1px 3px rgba(65,61,69,0.08)", shadowMd: "0 4px 12px rgba(65,61,69,0.1)", shadowLg: "0 10px 25px rgba(65,61,69,0.12)",
    motionFast: "200ms", motionNormal: "300ms",
    fonts: "Libre+Baskerville:ital,wght@0,400;0,700;1,400&family=Nunito:wght@400;600;700&family=Roboto+Mono:wght@400",
  },
  bold: {
