...
const SKILL_FILES = [
  ...
  { file: "start.md",                  phase: null, leverage: "high", surface: "code",           desc: "Pathlon's front door — starts or resumes a project in the current folder (a three-question intake), and routes each request to the right agent or skill." },
