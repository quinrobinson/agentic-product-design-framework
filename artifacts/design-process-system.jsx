  ...
  },
  {
    ...
    prompts: [
      ...
      },
      {
        ...
        prompt: `I'm building a design system for [PRODUCT TYPE]. The brand personality is [DESCRIBE TONE].\n\nPropose a foundational system including:\n- Type scale (with font pairing recommendations)\n- Color system (primary, secondary, semantic, neutral)\n- Spacing scale\n- Border radius philosophy\n- Elevation/shadow system\n- Component inventory (what I'll need for v1)\n- Motion principles (easing, duration guidelines)\n\nMake it opinionated. I want a system with a clear point of view, not a generic template.`,
        when: "Starting a new product or redesign",
        output: "Design system foundation spec",
      },
    ],
    templates: [
      {
    ...
    aiTools: ["Claude — Concept generation & critique", "Midjourney / DALL-E — Visual exploration", "Figma AI — Layout suggestions", "Relume — Sitemap & wireframe generation"],
    skillDocs: [
